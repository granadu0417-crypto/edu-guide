...
# 서대문구 동별 정보 (14개 행정동) - 고등학교
SEODAEMUN_DONGS = [
    {"id": "chunghyeon", "name": "충현동", "schools": ["중앙여고", "한성과학고"], "math_suffix": "내신·수능 대비", "eng_suffix": "독해·문법 완성"},
    {"id": "cheongyeon", "name": "천연동", "schools": ["한성과학고", "이화금란고"], "math_suffix": "맞춤 커리큘럼", "eng_suffix": "1:1 맞춤 수업"},
    {"id": "bukahyeon", "name": "북아현동", "schools": ["중앙여고"], "math_suffix": "기초부터 심화까지", "eng_suffix": "체계적 학습 관리"},
    {"id": "sinchon", "name": "신촌동", "schools": ["이화금란고", "이화여대부고"], "math_suffix": "학교별 내신 특화", "eng_suffix": "실력 향상 수업"},
    {"id": "yeonhui", "name": "연희동", "schools": ["명지고", "인창고"], "math_suffix": "1:1 맞춤 수업", "eng_suffix": "내신·수능 대비"},
    {"id": "hongje1", "name": "홍제1동", "schools": ["인창고"], "math_suffix": "개념부터 실전까지", "eng_suffix": "맞춤 커리큘럼"},
    {"id": "hongje2", "name": "홍제2동", "schools": ["인창고"], "math_suffix": "실력 향상 수업", "eng_suffix": "기초부터 심화까지"},
    {"id": "hongje3", "name": "홍제3동", "schools": ["인창고"], "math_suffix": "체계적 학습 관리", "eng_suffix": "학교별 내신 특화"},
    {"id": "hongeun1", "name": "홍은1동", "schools": ["명지고"], "math_suffix": "내신·수능 대비", "eng_suffix": "독해·문법 완성"},
    {"id": "hongeun2", "name": "홍은2동", "schools": ["명지고"], "math_suffix": "맞춤 커리큘럼", "eng_suffix": "1:1 맞춤 수업"},
    {"id": "namgajwa1", "name": "남가좌1동", "schools": ["가재울고", "명지고"], "math_suffix": "기초부터 심화까지", "eng_suffix": "체계적 학습 관리"},
    {"id": "namgajwa2", "name": "남가좌2동", "schools": ["가재울고", "명지고"], "math_suffix": "학교별 내신 특화", "eng_suffix": "실력 향상 수업"},
    {"id": "bukgajwa1", "name": "북가좌1동", "schools": ["가재울고"], "math_suffix": "1:1 맞춤 수업", "eng_suffix": "내신·수능 대비"},
    {"id": "bukgajwa2", "name": "북가좌2동", "schools": ["가재울고"], "math_suffix": "개념부터 실전까지", "eng_suffix": "맞춤 커리큘럼"},
]
...
{school}은 1992년 개교한 서울 소재 공립 과학고등학교입니다. 과학고답게 수학 수업 수준이 매우 높고, 심화 과정을 다룹니다. 내신 시험도 일반고와 차원이 다른 수준으로 출제됩니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
{school} 내신은 심화 수학 개념과 경시 수준 문제 풀이 능력이 필요합니다. 고난도 문제 접근법을 집중 훈련합니다.
</div>
"""
            elif school == "중앙여고":
                school_sections += f"""
...
{school}은 북아현동에 위치한 사립 여자 고등학교입니다. 중앙여중과 연계된 교육 시스템을 갖추고 있으며, 내신 경쟁이 치열합니다. 서술형 비중이 높아 풀이 과정을 논리적으로 쓰는 연습이 필수입니다.
...
"""
            elif school == "이화금란고" or school == "이화여대부고":
                school_sections += f"""
### {school} 수학 내신의 특징

{school}은 이화여자대학교 사범대학 부속 여자 고등학교입니다. 대학 부속 학교답게 교육의 질이 높고, 내신 시험도 체계적입니다. 심화 문제가 출제되어 깊이 있는 이해가 필요합니다.
...
{school}은 홍은동에 위치한 사립 고등학교입니다. 명지대학교와 연계된 교육 환경을 갖추고 있습니다. 내신에서 기본 개념 문제와 심화 문제가 균형 있게 출제됩니다.
...
{school}은 홍제동에 위치한 공립 고등학교입니다. 홍제천 인근의 주거지역에 위치하여 안정적인 학습 환경을 갖추고 있습니다. 교과서 중심의 기본 문제와 응용 문제가 출제됩니다.
...
{school}은 북가좌동에 위치한 공립 고등학교입니다. 가재울뉴타운 개발과 함께 설립되어 최신 교육 시설을 갖추고 있습니다. 젊은 학부모가 많아 교육열이 높고 내신 경쟁이 있습니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
{school} 기출문제를 분석하여 출제 경향을 파악합니다. 내신과 수능을 균형 있게 준비합니다.
</div>
"""
            else:
                school_sections += f"""
...
{school}은 서대문구에 위치한 고등학교입니다. 내신 시험에서 기본 개념 문제와 응용 문제가 균형 있게 출제됩니다.
...
{school}은 서대문구에 위치한 고등학교입니다. 내신 시험에서 기본 개념 문제와 응용 문제가 출제됩니다. 개념을 정확히 이해하고 다양한 문제를 풀어보는 것이 중요합니다.
...
"""
    ...
    content = f'''---
title: "서대문구 {dong_name} 고등 수학과외 | {school_list} {title_suffix}"
date: 2025-01-29
categories:
  - 고등교육
regions:
...
cities:
  - 서대문구
description: "서대문구 {dong_name} 고등학생 수학과외 전문. {school_list} 내신과 수능 맞춤 관리. 개념부터 심화까지 체계적 1:1 지도."
tags:
  - {dong_name}
  - 서대문구
  - 고등수학
...
---
## 서대문구 {dong_name} 고등학생, {intro_title}
...
서대문구 {dong_name} 고등학생 수학과외 수업료는 다음과 같습니다.
...
서대문구 {dong_name}에서 고등학생 수학과외를 찾고 계신다면, 지금 바로 상담받아보세요. {school_list} 내신과 수능에 맞춘 1:1 맞춤 수업으로 수학 실력을 확실히 올려드립니다.
'''
    return content
...
{school}은 1992년 개교한 서울 소재 공립 과학고등학교입니다. 과학고이지만 영어 수업 수준도 높습니다. 원서 독해와 과학 관련 영어 지문이 출제되기도 합니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
{school} 영어는 일반고와 다른 접근이 필요합니다. 과학 관련 어휘와 원서 독해 능력을 키웁니다.
</div>
"""
            elif school == "중앙여고":
                school_sections += f"""
...
{school}은 북아현동에 위치한 사립 여자 고등학교입니다. 영어 내신 경쟁이 치열하며, 꼼꼼한 암기와 정확한 문법 지식이 요구됩니다. 서술형에서 실수를 줄이는 것이 중요합니다.
...
{school}은 이화여자대학교 사범대학 부속 여자 고등학교입니다. 대학 부속 학교답게 영어 교육 수준이 높습니다. 교과서 본문뿐 아니라 심화 독해 지문도 출제됩니다.
...
{school}은 홍은동에 위치한 사립 고등학교입니다. 명지대학교와 연계된 교육 환경을 갖추고 있습니다. 교과서 본문 암기가 기본이며, 문법과 독해 문제가 균형 있게 출제됩니다.
...
{school}은 홍제동에 위치한 공립 고등학교입니다. 교과서 본문 암기가 핵심이며, 본문에 나온 문법과 표현이 시험에 출제됩니다.
...
{school}은 북가좌동에 위치한 공립 고등학교입니다. 가재울뉴타운 개발과 함께 설립되어 최신 교육 시설을 갖추고 있습니다. 교과서 중심의 출제가 이루어집니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
{school} 영어 교과서를 집중 분석합니다. 본문 암기와 핵심 문법 정리를 기본으로 합니다.
</div>
"""
            else:
                school_sections += f"""
...
{school}은 서대문구에 위치한 고등학교입니다. 교과서 본문 암기가 핵심이며, 본문에 나온 표현과 문법 사항이 그대로 시험에 출제됩니다.
...
{school}은 서대문구에 위치한 고등학교입니다. 교과서 본문 중심으로 출제되며, 핵심 문법과 어휘를 확실히 익혀야 합니다.
...
"""
    ...
    content = f'''---
title: "서대문구 {dong_name} 고등 영어과외 | {school_list} {title_suffix}"
date: 2025-01-29
categories:
  - 고등교육
regions:
...
cities:
  - 서대문구
description: "서대문구 {dong_name} 고등학생 영어과외 전문. {school_list} 내신과 수능 맞춤 관리. 문법·독해·어휘 체계적 1:1 지도."
tags:
  - {dong_name}
  - 서대문구
  - 고등영어
...
서대문구 {dong_name} 고등학생 영어과외 수업료는 다음과 같습니다.
...
서대문구 {dong_name}에서 고등학생 영어과외를 찾고 계신다면, 지금 바로 상담받아보세요. {school_list} 내신과 수능에 맞춘 1:1 맞춤 수업으로 영어 실력을 확실히 올려드립니다.
'''
    return content
...
def main():
    ...
    for i, dong in enumerate(SEODAEMUN_DONGS):
        # 수학 파일 생성
        math_filename = f"seodaemun-{dong['id']}-high-math.md"
        ...
        # 영어 파일 생성
        english_filename = f"seodaemun-{dong['id']}-high-english.md"
    ...
    print(f"서대문구 고등: {len(created_files)}개 파일 생성 완료")
