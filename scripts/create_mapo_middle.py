...
# 마포구 동별 정보 (16개 행정동)
MAPO_DONGS = [
    {"id": "gongdeok", "name": "공덕동", "schools": ["아현중", "숭문중"], "math_suffix": "내신 완벽 대비", "eng_suffix": "독해·문법 완성"},
    {"id": "ahyeon", "name": "아현동", "schools": ["아현중"], "math_suffix": "맞춤 커리큘럼", "eng_suffix": "1:1 맞춤 수업"},
    {"id": "dohwa", "name": "도화동", "schools": ["아현중", "신수중"], "math_suffix": "기초부터 심화까지", "eng_suffix": "체계적 학습 관리"},
    {"id": "yonggang", "name": "용강동", "schools": ["신수중", "창천중"], "math_suffix": "학교별 내신 특화", "eng_suffix": "실력 향상 수업"},
    {"id": "daeheung", "name": "대흥동", "schools": ["숭문중"], "math_suffix": "1:1 맞춤 수업", "eng_suffix": "내신 완벽 대비"},
    {"id": "yeomni", "name": "염리동", "schools": ["서울여중", "동도중"], "math_suffix": "개념부터 실전까지", "eng_suffix": "맞춤 커리큘럼"},
    {"id": "sinsu", "name": "신수동", "schools": ["신수중"], "math_suffix": "실력 향상 수업", "eng_suffix": "기초부터 심화까지"},
    {"id": "seogang", "name": "서강동", "schools": ["창천중"], "math_suffix": "체계적 학습 관리", "eng_suffix": "학교별 내신 특화"},
    {"id": "seogyo", "name": "서교동", "schools": ["창천중", "성산중"], "math_suffix": "내신 완벽 대비", "eng_suffix": "독해·문법 완성"},
    {"id": "hapjeong", "name": "합정동", "schools": ["성산중"], "math_suffix": "맞춤 커리큘럼", "eng_suffix": "1:1 맞춤 수업"},
    {"id": "mangwon1", "name": "망원1동", "schools": ["성산중", "성사중"], "math_suffix": "기초부터 심화까지", "eng_suffix": "체계적 학습 관리"},
    {"id": "mangwon2", "name": "망원2동", "schools": ["성산중", "성사중"], "math_suffix": "학교별 내신 특화", "eng_suffix": "실력 향상 수업"},
    {"id": "yeonnam", "name": "연남동", "schools": ["성사중"], "math_suffix": "1:1 맞춤 수업", "eng_suffix": "내신 완벽 대비"},
    {"id": "seongsan1", "name": "성산1동", "schools": ["성서중", "홍익대부속여중"], "math_suffix": "개념부터 실전까지", "eng_suffix": "맞춤 커리큘럼"},
    {"id": "seongsan2", "name": "성산2동", "schools": ["성서중", "홍익대부속여중"], "math_suffix": "실력 향상 수업", "eng_suffix": "기초부터 심화까지"},
    {"id": "sangam", "name": "상암동", "schools": ["상암중"], "math_suffix": "체계적 학습 관리", "eng_suffix": "학교별 내신 특화"},
]
...
{school}은 1906년 개교한 마포구의 전통 있는 사립 중학교입니다. 오랜 역사만큼 내신 시험의 체계가 잘 잡혀 있습니다. 기본 개념 문제와 응용 문제가 균형 있게 출제되며, 서술형 비중이 높은 편입니다.
...
{school}은 염리동에 위치한 여자 사립 중학교입니다. 내신 경쟁이 치열하며, 꼼꼼한 준비가 필요합니다. 교과서 내용을 충실히 이해하고, 다양한 유형의 문제를 풀어봐야 합니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
{school} 내신은 기본기가 핵심입니다. 교과서 개념을 완벽히 이해한 후, 기출 유형을 집중 연습합니다.
</div>
"""
            elif school == "홍익대부속여중":
                school_sections += f"""
...
{school}은 홍익대학교 사범대학 부속 여자 중학교입니다. 대학 부속 학교답게 교육의 질이 높고, 내신 시험도 체계적입니다. 개념 이해와 응용력을 함께 평가합니다.
...
{school}은 상암동 디지털미디어시티 인근에 위치한 공립 중학교입니다. 신도시 특성상 교육열이 높은 학부모가 많아 내신 경쟁이 있습니다. 교과서 중심의 기본 문제와 응용 문제가 출제됩니다.
...
{school}은 마포구에 위치한 중학교입니다. 교과서 중심의 기본 문제와 응용 문제가 균형 있게 출제됩니다. 교과서 예제를 완벽히 이해하고, 익힘책 문제까지 풀어두면 좋은 성적을 받을 수 있습니다.
...
{school}은 마포구에 위치한 중학교입니다. 내신 시험에서 기본 개념 문제와 응용 문제가 출제됩니다. 개념을 정확히 이해하고 다양한 문제를 풀어보는 것이 중요합니다.
...
"""
    ...
    content = f'''---
title: "마포구 {dong_name} 중등 수학과외 | {school_list} {title_suffix}"
date: 2025-01-29
categories:
  - 중등교육
regions:
...
cities:
  - 마포구
description: "마포구 {dong_name} 중학생 수학과외 전문. {school_list} 내신 맞춤 관리. 개념부터 심화까지 체계적 1:1 지도."
tags:
  - {dong_name}
  - 마포구
  - 중등수학
...
마포구는 서강대, 홍익대 등 대학가가 형성된 교육 중심 지역입니다. 홍대 문화와 상암 DMC의 영향으로 창의적이고 열린 교육 분위기가 있습니다.
...
마포구 {dong_name} 중학생 수학과외 수업료는 다음과 같습니다.
...
마포구 {dong_name}에서 중학생 수학과외를 찾고 계신다면, 지금 바로 상담받아보세요. {school_list} 내신에 맞춘 1:1 맞춤 수업으로 수학 실력을 확실히 올려드립니다.
'''
    return content
...
{school}은 1906년 개교한 마포구의 전통 있는 사립 중학교입니다. 영어 교육에서도 체계적인 시스템을 갖추고 있습니다. 교과서 본문 암기가 기본이며, 문법과 독해 문제가 균형 있게 출제됩니다.
...
{school}은 염리동에 위치한 여자 사립 중학교입니다. 영어 내신 경쟁이 치열하며, 본문 암기와 문법 이해가 핵심입니다. 서술형 비중이 있어 영작 실력도 필요합니다.
...
{school}은 홍익대학교 사범대학 부속 여자 중학교입니다. 대학 부속 학교답게 영어 교육 수준이 높습니다. 교과서 본문뿐 아니라 심화 독해 지문도 출제됩니다.
...
{school}은 상암동 디지털미디어시티 인근에 위치한 공립 중학교입니다. 교과서 본문 암기가 핵심이며, 본문에 나온 문법과 표현이 시험에 출제됩니다.
...
{school}은 마포구에 위치한 중학교입니다. 교과서 본문 암기가 핵심이며, 본문에 나온 표현과 문법 사항이 그대로 시험에 출제됩니다. 본문을 통째로 외우고, 핵심 문법을 정확히 이해해야 합니다.
...
{school}은 마포구에 위치한 중학교입니다. 교과서 본문 중심으로 출제되며, 핵심 문법과 어휘를 확실히 익혀야 합니다.
...
"""
    ...
    content = f'''---
title: "마포구 {dong_name} 중등 영어과외 | {school_list} {title_suffix}"
date: 2025-01-29
categories:
  - 중등교육
regions:
...
cities:
  - 마포구
description: "마포구 {dong_name} 중학생 영어과외 전문. {school_list} 내신 맞춤 관리. 문법·독해·어휘 체계적 1:1 지도."
tags:
  - {dong_name}
  - 마포구
  - 중등영어
...
마포구는 서강대, 홍익대 등 대학가가 형성된 지역입니다. 홍대 문화의 개방적인 분위기와 함께 교육에 대한 관심도 높습니다.
...
마포구 {dong_name} 중학생 영어과외 수업료는 다음과 같습니다.
...
마포구 {dong_name}에서 중학생 영어과외를 찾고 계신다면, 지금 바로 상담받아보세요. {school_list} 내신에 맞춘 1:1 맞춤 수업으로 영어 실력을 확실히 올려드립니다.
'''
    return content
...
def main():
    ...
    for i, dong in enumerate(MAPO_DONGS):
        # 수학 파일 생성
        math_filename = f"mapo-{dong['id']}-middle-math.md"
        ...
        # 영어 파일 생성
        english_filename = f"mapo-{dong['id']}-middle-english.md"
    ...
    print(f"마포구 중등: {len(created_files)}개 파일 생성 완료")
