...
# 도봉구 동별 정보 (14개 행정동)
# 고등학교: 도봉고, 선덕고, 서라벌고, 창동고, 서울외국어고(특목고)
DOBONG_DONGS = [
    {"id": "ssangmun1", "name": "쌍문1동", "schools": ["선덕고", "서라벌고"]},
    {"id": "ssangmun2", "name": "쌍문2동", "schools": ["선덕고", "서라벌고"]},
    {"id": "ssangmun3", "name": "쌍문3동", "schools": ["선덕고", "서라벌고"]},
    {"id": "ssangmun4", "name": "쌍문4동", "schools": ["선덕고", "서라벌고"]},
    {"id": "chang1", "name": "창1동", "schools": ["창동고", "서울외국어고"]},
    {"id": "chang2", "name": "창2동", "schools": ["창동고", "서울외국어고"]},
    {"id": "chang3", "name": "창3동", "schools": ["창동고", "서울외국어고"]},
    {"id": "chang4", "name": "창4동", "schools": ["창동고"]},
    {"id": "chang5", "name": "창5동", "schools": ["창동고"]},
    {"id": "banghak1", "name": "방학1동", "schools": ["창동고", "도봉고"]},
    {"id": "banghak2", "name": "방학2동", "schools": ["창동고", "도봉고"]},
    {"id": "banghak3", "name": "방학3동", "schools": ["창동고", "도봉고"]},
    {"id": "dobong1", "name": "도봉1동", "schools": ["도봉고"]},
    {"id": "dobong2", "name": "도봉2동", "schools": ["도봉고"]},
]
...
def create_dobong_high_math_content(dong_info, index):
...
{school}는 서울 동북권 명문 외국어고입니다. 외고 특성상 문과 수학 비중이 높지만, 수학적 사고력을 요구하는 문제가 출제됩니다. 내신 경쟁이 치열하여 1점 차이로 등급이 바뀌는 경우가 많습니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
{school} 기출문제를 철저히 분석합니다. 외고 수학의 특성을 고려한 맞춤 내신 대비를 진행합니다.
</div>
"""
            else:
                school_sections += f"""
...
{school}은 도봉구의 대표적인 고등학교입니다. 교과서 개념을 충실히 다루면서도 응용력을 요구하는 문제가 출제됩니다. 서술형 비중이 있어 풀이 과정을 논리적으로 작성하는 연습이 필요합니다.
...
"""
    ...
    content = f'''---
title: "도봉구 {dong_name} 고등 수학과외 | {school_list} 내신·수능 대비"
date: 2025-01-29
categories:
  - 고등교육
regions:
...
cities:
  - 도봉구
description: "도봉구 {dong_name} 고등학생 수학과외 전문. {school_list} 내신 및 수능 동시 대비. 개념부터 킬러 문항까지 체계적 1:1 지도."
tags:
  - {dong_name}
  - 도봉구
  - 고등수학
...
---
## 도봉구 {dong_name} 고등학생, {intro_title}

{intro_detail} {dong_name}에서 고등학생 자녀의 수학 때문에 고민하시는 학부모님이 많습니다. 고등학교 수학은 중학교와 차원이 다릅니다. 개념의 깊이도, 문제의 난이도도 확 올라갑니다.
...
도봉구 {dong_name}에서 고등학생 수학과외를 찾고 계신다면, 지금 바로 상담받아보세요. {school_list} 내신과 수능에 맞춘 1:1 맞춤 수업으로 수학 실력을 확실히 끌어올립니다. 고등학교 수학은 대입의 핵심입니다. 지금 시작하면 달라집니다.
'''
    return content


def create_dobong_high_english_content(dong_info, index):
    dong_name = dong_info["name"]
    schools = dong_info["schools"]
    school_list = get_school_list_text(schools)
    school_tags = get_school_tags(schools)
...
{school}는 서울 동북권 대표 외국어고입니다. 외고 특성상 영어 내신의 난이도가 매우 높습니다. 교과서 외 지문이 다수 출제되고, 고급 어휘와 복잡한 문장 구조에 대한 이해가 필수입니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
{school} 영어 기출을 철저히 분석합니다. 외고 수준의 고난도 독해와 어휘를 집중 훈련합니다.
</div>
"""
            else:
                school_sections += f"""
...
"""
    ...
    content = f'''---
title: "도봉구 {dong_name} 고등 영어과외 | {school_list} 내신·수능 대비"
date: 2025-01-29
categories:
  - 고등교육
regions:
...
cities:
  - 도봉구
description: "도봉구 {dong_name} 고등학생 영어과외 전문. {school_list} 내신 및 수능 동시 대비. 독해·문법·어휘 체계적 1:1 지도."
tags:
  - {dong_name}
  - 도봉구
  - 고등영어
...
도봉구 {dong_name}에서 고등학생 영어과외를 찾고 계신다면, 지금 바로 상담받아보세요. {school_list} 내신과 수능에 맞춘 1:1 맞춤 수업으로 영어 실력을 확실히 끌어올립니다. 고등학교 영어는 대입의 핵심입니다. 지금 시작하면 달라집니다.
'''
    return content
...
def main():
    ...
    for i, dong in enumerate(DOBONG_DONGS):
        # 수학 파일 생성
        math_filename = f"dobong-{dong['id']}-high-math.md"
        math_filepath = os.path.join(output_dir, math_filename)
        math_content = create_dobong_high_math_content(dong, i)
        ...
        # 영어 파일 생성
        english_filename = f"dobong-{dong['id']}-high-english.md"
        english_filepath = os.path.join(output_dir, english_filename)
        english_content = create_dobong_high_english_content(dong, i)

        with open(english_filepath, 'w', encoding='utf-8') as f:
            f.write(english_content)
        created_files.append(english_filename)

    print(f"도봉구 고등: {len(created_files)}개 파일 생성 완료")
