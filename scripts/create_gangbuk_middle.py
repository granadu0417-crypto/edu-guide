...
1학기에는 소인수분해와 정수, 유리수 연산에 집중합니다. 2학기에는 문자와 식, 일차방정식을 배웁니다.
...
내신 관리와 함께 고등 수학 선행도 고려해야 하는 시기입니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
학년별 핵심 단원을 체계적으로 정리합니다. 다음 학년으로 연결되는 개념은 반드시 완벽히 마스터합니다.
</div>
...
틀린 문제는 반드시 오답 노트에 정리합니다. 시험 직전에 오답 노트를 복습하면 효과적입니다.
...
강북구 {dong_name}에서 중학생 수학과외를 찾고 계신다면, 지금 바로 상담받아보세요. {school_list} 내신에 맞춘 1:1 맞춤 수업으로 수학 실력을 확실히 올려드립니다. 수학 때문에 고민하는 시간이 길어질수록 손해입니다. 지금 시작하면 다음 시험에서 결과가 달라집니다.
'''
    return content
...
강북구 {dong_name}에서 중학생 영어과외를 찾고 계신다면, 지금 바로 상담받아보세요. {school_list} 내신에 맞춘 1:1 맞춤 수업으로 영어 실력을 확실히 올려드립니다. 영어 때문에 고민하는 시간이 길어질수록 손해입니다. 지금 시작하면 다음 시험에서 결과가 달라집니다.
'''
    return content
