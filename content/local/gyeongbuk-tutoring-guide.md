...
2. **대구 접근성 (포항·구미·경주)**
   ...
   - 경주 ↔ 대구: 30분
   - 포항 ↔ 대구: 40분
   - 경북대생: 적정한 비용~적정한 비용/시간
   - 경북대 의대생: 적정한 비용~적정한 비용
   - 계명대생: 적정한 비용~적정한 비용

3. **지역 대학 활용**
   - 금오공대 (구미): 적정한 비용~적정한 비용
   - 안동대 (안동): 적정한 비용~적정한 비용
   - 한동대·동국대 경주: 적정한 비용~적정한 비용
...
| 방식 | 횟수 | 비용 | 특징 |
|-----|-----|------|------|
| 포항 학원 | 주 3회 | 적정한 비용~적정한 비용 | 진도 중심 |
| 금오공대생 | 주 2회 | 적정한 비용~적정한 비용 | 기본 관리 |
| 경북대생 | 주 2회 | 적정한 비용~적정한 비용 | 우수 관리 |
| POSTECH생 | 주 2회 | 적정한 비용~적정한 비용 | 최상위 |
