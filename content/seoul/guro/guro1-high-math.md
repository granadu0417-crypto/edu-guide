...
cities:
  - 구로구
description: "구로구 구로1동 고등학생 수학과외 전문. 구로고·구현고 내신과 수능 동시 대비. 개념부터 킬러문항까지 체계적 1:1 지도."
tags:
  - 구로구
  - 구로1동
  - 고등수학
...
킬러 문항도 정복할 수 있습니다. 구로구 구로1동에서 고등학교 수학 과외를 찾고 계시다면, 체계적인 수업으로 내신과 수능을 동시에 준비하세요.
