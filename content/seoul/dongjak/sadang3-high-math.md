...
cities:
  - 동작구
description: "동작구 사당3동 고등학생 수학과외 전문. 동작고·경문고 내신과 수능 동시 대비. 개념부터 킬러문항까지 체계적 1:1 지도."
tags:
  - 동작구
  - 사당3동
  - 고등수학
...
내 아이 수학, 왜 이렇게 안 오르는 걸까요? 동작구 사당3동에서 고등학교 수학 과외를 찾고 계시다면, 체계적인 수업으로 내신과 수능을 동시에 준비하세요.
