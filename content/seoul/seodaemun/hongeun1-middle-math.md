...
cities:
  - 서대문구
description: "서대문구 홍은1동 중학생 수학과외 전문. 홍은중·명지중 내신 맞춤 관리. 개념부터 심화까지 체계적 1:1 지도."
tags:
  - 홍은1동
  - 서대문구
  - 중등수학
...
---
## 서대문구 홍은1동 중학생, 수학 때문에 스트레스라면

수학 스트레스, 함께 해결해 드립니다. 홍은1동에서 중학생 자녀의 수학 성적 때문에 고민하시는 학부모님이 많습니다. 학원을 보내도, 문제집을 풀려도 성적이 오르지 않는 이유는 학생 개인의 취약점을 정확히 파악하지 못했기 때문입니다.
...
명지중은 서대문구에 위치한 중학교입니다. 내신 시험에서 기본 개념 문제와 응용 문제가 출제됩니다. 개념을 정확히 이해하고 다양한 문제를 풀어보는 것이 중요합니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
명지중의 기출문제를 집중 분석합니다. 취약 유형을 파악하고 반복 훈련으로 실력을 키웁니다.
</div>
...
서대문구 홍은1동 중학생 수학과외 수업료는 다음과 같습니다.
...
서대문구 홍은1동에서 중학생 수학과외를 찾고 계신다면, 지금 바로 상담받아보세요. 홍은중·명지중 내신에 맞춘 1:1 맞춤 수업으로 수학 실력을 확실히 올려드립니다.
