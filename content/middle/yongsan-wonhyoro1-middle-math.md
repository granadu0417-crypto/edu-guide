...
고등학교 가기 전에 반드시 완성해야 합니다. 용산구 원효로1동 중학생들을 위한 맞춤형 수학 과외를 소개합니다.
...
특히 원효로1동 학생들이 다니는 선린중 등의 학교에서는 서술형 평가 비중이 높아지고 있습니다. 단순히 답만 맞히는 것이 아니라, 풀이 과정을 논리적으로 서술하는 능력이 필요합니다.
...
용산구 원효로1동 중학생 여러분, 수학은 올바른 방법으로 공부하면 반드시 성적이 오릅니다. 지금 시작하면 늦지 않았습니다. 함께 수학 실력을 키워나가요.
