...
---
## 관악구 미성동 중학생, 학원에서는 이해가 됐는데 혼자 풀면 모르겠나요?

미성동에서 중학생 자녀의 수학 때문에 고민이 많으시죠. 학원도 보내보고 문제집도 풀려봤지만 성적이 오르지 않는다면, 학생 개인의 약점을 제대로 파악하지 못한 것일 수 있습니다. 1:1 맞춤 과외로 정확한 진단부터 시작해보세요.
...
## 남서울중·미성중·성보중 수학 시험의 특징

남서울중은 교과서 중심의 기본 문제와 응용 문제를 균형 있게 출제합니다. 개념을 정확히 이해하고 다양한 유형을 연습하면 좋은 성적을 받을 수 있습니다.

미성중은 서술형 비중이 높은 편입니다. 풀이 과정을 논리적으로 작성하는 연습이 필요합니다. 계산 과정도 꼼꼼히 채점합니다.

<div style="background-color: #FDF8F0; border-left: 3px solid #d4a574; padding: 18px; margin: 15px 0; font-size: 0.95em;">
<strong>이렇게 수업합니다!</strong><br>
남서울중·미성중·성보중 기출문제를 분석하여 자주 나오는 유형을 파악합니다. 학교 시험에 맞춘 전략적 대비를 합니다.
</div>
...
관악구 미성동에서 중학생 수학과외를 찾고 계신다면, 지금 상담받아보세요. 남서울중·미성중·성보중 내신에 맞춘 1:1 맞춤 수업으로 수학 실력을 확실히 끌어올려 드립니다.
