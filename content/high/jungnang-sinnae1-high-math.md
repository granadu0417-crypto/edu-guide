...
신내1동에서는 묵1동, 망우3동 지역 고등학교로 통학하는 학생들이 많습니다. 각 학교별 출제 경향이 다르므로 학교 맞춤형 대비가 중요합니다.
...
중랑구 신내1동 고등학생 여러분, 수학 때문에 고민이라면 지금 시작하세요. 고등학교 수학은 어렵지만, 제대로 된 방법으로 공부하면 반드시 오릅니다. 함께 시작해보시겠습니까?
