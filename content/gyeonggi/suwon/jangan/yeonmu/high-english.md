...
cities:
  - 장안구
description: "수원시 장안구 연무동 고등학생 영어과외 전문. 수성고 내신과 수능 동시 대비. 독해부터 문법까지 체계적 1:1 지도."
tags:
  - 수원시
  - 장안구
  - 연무동
...
수성고은 영어 내신 시험 난이도가 높습니다. 교과서 본문 암기는 기본이고, 변형 문제와 외부 지문이 출제되기도 합니다. 문법, 어휘, 독해를 균형 있게 준비해야 합니다.
...
장안구 연무동 학생 여러분, 변화는 결심에서 시작됩니다. 지금 연락 주세요.
